...
if __name__ == "__main__":
    ...
    IMAGE_DIR = '/home/orangepi/daima/picture_for_test'  # 图片文件夹路径
    OUTPUT_DIR = '/home/orangepi/daima/fanhui_all/results'  # 输出文件夹
    ...
    for img_path in image_paths:
        ...
        # 可视化
        vis_start = time.time()
        output_name = f"{os.path.splitext(os.path.basename(img_path))[0]}_pred_{prediction}.png"
